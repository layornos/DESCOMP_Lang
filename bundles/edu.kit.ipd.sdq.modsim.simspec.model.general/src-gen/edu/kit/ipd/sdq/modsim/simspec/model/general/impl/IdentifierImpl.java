 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.simspec.model.general.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifierImpl extends MinimalEObjectImpl.Container implements Identifier {
	...
	protected EClass eStaticClass() {
		return GeneralPackage.Literals.IDENTIFIER;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.IDENTIFIER__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneralPackage.IDENTIFIER__ID:
			return getId();
		}
